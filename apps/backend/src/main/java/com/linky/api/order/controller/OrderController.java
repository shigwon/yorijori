...
public class OrderController {
    ...
    public ResponseEntity<ApiResponseEntity<Object>> createOrder(@RequestBody CreateOrderRequestDto createOrderRequest) {
        ...
        if(success) {
            ...
            messageService.messageSend(order.getTel(), "https://i13c102.p.ssafy.io/customer?orderId=" + orderId +"&robotId=" + order.getRobotId() + "&code=" + order.getCode() + "&sectionNum=" + sectionNum);
