...
const { goToPhotoCapture, setProgressPercent, goToScanConfirmModal } = useAppState()

onMounted(() => {
  setProgressPercent(70) // Set progress to 70% on this screen
})
